    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item font-weight-bold">
                <a class="nav-link" href="<?php echo e(url('/'.$level)); ?>">
            ...
            <li class="nav-item font-weight-bold">
                <a class="nav-link" href="<?php echo e(url('/'.$level.'/data/masyarakat')); ?>">
                ...
                <li class="nav-item font-weight-bold">
                    ...
                    <div id="collapsePetugas" class="collapse" aria-labelledby="headingPetugas" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item" href="<?php echo e(url('/admin/data/petugas')); ?>">Data Petugas</a>
                            <a class="collapse-item" href="<?php echo e(url('/admin/register')); ?>">Registrasi Petugas</a>
                        </div>
                    </div>
                </li>
            <?php endif; ?>
            ...
            <!-- Nav Item - Data Masyarakat -->
            <li class="nav-item font-weight-bold">
                <a class="nav-link" href="<?php echo e(url('/'.$level.'/data/pengaduan')); ?>">
            ...
            <?php if($level == 'admin'): ?>
                ...
                <li class="nav-item font-weight-bold">
                    ...
                    <div id="collapseTanggapan" class="collapse" aria-labelledby="headingPetugas" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item" href="<?php echo e(url('/admin/data/tanggapan')); ?>">Semua Data Tanggapan</a>
                            <a class="collapse-item" href="<?php echo e(url('/'.$level.'/data/tanggapan/saya')); ?>">Data Tanggapan Anda</a>
                        </div>
                    </div>
                </li>
            <?php else: ?>
                ...
                <!-- Nav Item - Data Masyarakat -->
                <li class="nav-item font-weight-bold">
                    <a class="nav-link" href="<?php echo e(url('/'.$level.'/data/tanggapan/saya')); ?>">
                        <i class="fas fa-clipboard-check"></i>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="<?php echo e(url('/'.$level.'/profile')); ?>">
...
</html><?php /**PATH D:\Folder_iqbal\Ujikom\Pengaduan-Masyarakat\resources\views////layouts/layout-petugas.blade.php ENDPATH**/ ?>