        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-success topbar mb-4 static-top shadow">
                    ...
                    <a href="{{url('/masyarakat')}}" class="text-decoration-none">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-sm-inline text-white small">{{auth()->user()->nama}}</span>
                                <button class="btn btn-lg btn-dark py-1 px-2"><i class="fas fa-user text-light"></i></button>
                            </a>
                            <!-- Dropdown - User Information -->
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="{{url('/masyarakat/profile')}}">
