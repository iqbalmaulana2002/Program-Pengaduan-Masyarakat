...
<body>
  ...
  <!-- ======= Hero Section ======= -->
  <section style="background-image: url({{asset('landing-page/assets/img/cover.jpg')}}); background-repeat: no-repeat; background-size: 110% 200%;">
    <div class="container text-center">
      ...
      <div class="col-md-12 text-center align-item-center">
        ...
        <p class="text-white">Tingkat Kecamatan Cinere</p>
        <a class="btn btn-sm scrollto" href="{{url('/login')}}">Login Sekarang</a>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="#features">Contoh Permasalahan</a></li>
          <li><a href="{{url('/register')}}">Registrasi sebagai masyarakat</a></li>
        </ul>
      </nav>
      <!-- #nav-menu-container -->
  ...
  <main id="main">
    ...
    <section class="welcome text-center">
      ...
      <p>
        Jika kalian ada masalah, silahkan adukan masalah anda disini
      </p>
        ...
        <div class="row">
          <div class="feature-col col-md-4">
            <div class="card card-block text-center">
              <div>
                <div>
                  <img src="{{asset('landing-page/assets/img/porf-2.jpg')}}" style="width: 300px; height: 150px;">
                </div>
              </div>
            </div>
          </div>

          <div class="feature-col col-md-4 col-xs-12">
            <div class="card card-block text-center">
              <div>
                <div>
                  <img src="{{asset('landing-page/assets/img/porf-3.jpg')}}" style="width: 300px; height: 150px;">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="feature-col col-md-4 col-xs-12">
            <div class="card card-block text-center">
              <div>
                <div>
                  <img src="{{asset('landing-page/assets/img/porf-4.jpg')}}" style="width: 300px; height: 150px;">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="feature-col col-md-4 col-xs-12">
            <div class="card card-block text-center">
              <div>
                <div>
                  <img src="{{asset('landing-page/assets/img/porf-5.jpg')}}" style="width: 300px; height: 150px;">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="feature-col col-md-4 col-xs-12">
            <div class="card card-block text-center">
              <div>
                <div>
                  <img src="{{asset('landing-page/assets/img/porf-6.jpg')}}" style="width: 300px; height: 150px;">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="feature-col col-md-4 col-xs-12">
            <div class="card card-block text-center">
              <div>
                <div>
                  <img src="{{asset('landing-page/assets/img/porf-1.jpg')}}" style="width: 300px; height: 150px;">
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 col-xs-12 text-lg-left text-center">
            ...
            <div class="credits">
              Created by <a href="">Iqbal Maulana</a>
            </div>
          </div>
